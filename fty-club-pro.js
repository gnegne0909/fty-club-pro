...
const GLOBAL_CSS = `
@import url('https://fonts.googleapis.com/css2?family=Rajdhani:wght@300;400;500;600;700;900&family=Barlow:wght@300;400;500;600;700;800;900&family=Space+Mono:wght@400;700&display=swap');

/* ========== RESET ========== */
*, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }

:root {
    /* Couleurs Premium E-sport */
    --primary: #00FFA3;
    --primary-dark: #00CC82;
    --primary-glow: rgba(0, 255, 163, 0.5);
    --secondary: #FF006B;
    --secondary-glow: rgba(255, 0, 107, 0.5);
    --accent: #00D4FF;
    ...
    --shadow-glow: 0 0 40px var(--primary-glow), 0 0 60px var(--primary-glow);
}
...
.display-2 { font-size: clamp(2.5rem, 6vw, 4rem); font-weight: 800; }
.display-3 { font-size: clamp(2rem, 4vw, 3rem); font-weight: 700; }
...
<body>
    <div class="recovery-container">
        <div class="recovery-card">
            ...
            <form method="POST" action="/panel/forgot-password" id="forgotPasswordForm">
                <div class="form-group">
                ...
                <button type="button" onclick="confirmAndSubmit()" class="btn btn-primary btn-full">
                    📨 Envoyer la demande
                </button>
            </form>
            ...
            function confirmAndSubmit() {
                ...
                const discordId = document.querySelector('input[name="discordId"]').value;
                const reason = document.querySelector('textarea[name="reason"]').value;
                
                if (!username || !discordId) {
                    alert('❌ Nom d\'utilisateur et Discord ID requis');
                    return;
                }
                
                let message = 'Tu vas envoyer une demande de reset pour :\n\n';
                message += '👤 Compte: ' + username + '\n';
                message += '🎮 Discord ID: ' + discordId + '\n';
                message += '📝 Raison: ' + (reason || 'Aucune') + '\n\n';
                message += 'Le staff sera notifié. Confirmer ?';
